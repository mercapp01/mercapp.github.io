...
Tu sitio publicado ha sido **https://mercapp01.netlify.app**, pero pediste
**https://mercapp.netlify.app** (sin el 01). USA EL QUE REALMENTE ESTA EN LINEA.
Si tu dominio real es mercapp01, deja ese. Para cambiarlo en la app edita una
sola linea en app.js (o index.html):

```js
const SITE_URL='https://mercapp01.netlify.app';   // <-- pon aqui tu dominio real
```
...
`https://mercapp.netlify.app/auth/v1/callback` NO es valida.
